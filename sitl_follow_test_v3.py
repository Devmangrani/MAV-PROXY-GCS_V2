...
class GPSSITLFollow:
    ...
    def follow_gps(self):
        ...
        logger.info(f"Starting GPS follow with {self.distance_threshold}m distance threshold")
                    ...
                    try:
                        ...
                        if msg.sentence_type == 'GGA':
                            if msg.latitude and msg.longitude:
                                ...
                                target_lat = float(msg.latitude)
                                target_lon = float(msg.longitude)
                                ...
                                if distance > self.distance_threshold:
                                    ...
                                    logger.info(
                                        ...
                                        f"Target Position: {target_lat:.6f}, {target_lon:.6f}\n"
